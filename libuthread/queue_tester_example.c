...
// is there a max size of queue??

// /* Test queue operations when queue is full */
// void test_full_queue(void)
// {
//     int data1 = 1, data2 = 2, data3 = 3, data4 = 4;
//     queue_t q;

//     fprintf(stderr, "*** TEST full_queue ***\n");
...
//     // Queue is full now
//     TEST_ASSERT(queue_enqueue(q, &data4) == -1); // Attempt to enqueue should fail

//     // Dequeue some elements to free up space
//     queue_dequeue(q, NULL);
//     queue_dequeue(q, NULL);

//     // Enqueue should succeed now
//     TEST_ASSERT(queue_enqueue(q, &data4) == 0);
// }
